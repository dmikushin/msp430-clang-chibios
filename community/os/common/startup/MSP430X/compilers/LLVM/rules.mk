...
# Be very GCC-friendly
OPT += -fheinous-gnu-extensions
...
LDFLAGS   = $(LLIBDIR) -Map=$(BUILDDIR)/$(PROJECT).map --cref --no-warn-mismatch --library-path=$(RULESPATH)/ld --script=$(LDSCRIPT) $(LDOPT)
